...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/project/node_modules/ufo/dist/index.mjs';
...
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/project/.nitro"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/project/.nitro/cache"}));
...
const _lazy_SBFa1j = () => Promise.resolve().then(function () { return index$1; });

const handlers = [
  { route: '/', handler: _lazy_SBFa1j, lazy: true, middleware: false, method: undefined }
];
